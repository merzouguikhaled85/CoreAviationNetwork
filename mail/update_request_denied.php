                    ...
                    <tr>
                        <td style="padding:36px 38px;">
                            ...
                            <p style="margin:0 0 22px; font-size:15px; line-height:1.7; color:#374151;">
                                We regret to inform you that the update request for the aircraft
                                <strong><?= Html::encode($aircraftRegistration) ?></strong> has been denied.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#9a3412;">
                                            Your requested update could not be approved at this time.
                                            Please contact the support team if you need further clarification.
                                        </p>
                                    </td>
                                </tr>
                            </table>
