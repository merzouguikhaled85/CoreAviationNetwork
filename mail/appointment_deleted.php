...
$appointmentDate = !empty($appointment->appointment_date)
    ? Yii::$app->formatter->asDatetime($appointment->appointment_date, 'php:Y-m-d H:i')
    : 'N/A';
?>
                    ...
                    <tr>
                        <td style="padding:36px 38px;">
                            ...
                            <p style="margin:0 0 22px; font-size:15px; line-height:1.7; color:#374151;">
                                Your appointment for request
                                <strong>#<?= Html::encode($requestId) ?></strong>
                                has been removed.
                            </p>

                            <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef2f2; border:1px solid #fecaca; border-radius:12px; margin:24px 0;">
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#b91c1c;">
                                            This appointment is no longer available in the schedule.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.7; color:#374151;">
                                Please contact the support team if you require more information.
                            </p>
