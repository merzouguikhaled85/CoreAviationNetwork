...
$userName = $appointment->user->name ?? 'User';
$appointmentId = $appointment->id ?? 'N/A';

$appointmentDate = !empty($appointment->start_time)
                                ...
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#1e40af;">
                                            Please make sure to be available at the scheduled date and time.
                                        </p>
                                    </td>
                                </tr>
                            </table>
