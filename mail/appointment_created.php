...
/* @var $application app\models\Appointment */

$ao = AoProfile::findOne($application->ao_id);

$appName = Yii::$app->name ?: 'Core Aviation Network';

$aoName = $ao->username ?? 'AO';
$requestId = $application->request_id ?? 'N/A';

$appointmentDate = !empty($application->appointment_date)
    ? Yii::$app->formatter->asDatetime($application->appointment_date)
    : 'N/A';
?>
                    ...
                    <tr>
                        <td style="padding:36px 38px;">
                            ...
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.7; color:#374151;">
                                Hello <?= Html::encode($aoName) ?>,
                            </p>

                            <p style="margin:0 0 22px; font-size:15px; line-height:1.7; color:#374151;">
                                A new appointment has been requested and is waiting for your review.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#1e40af;">
                                            Please review this appointment request in your dashboard and take the appropriate action.
                                        </p>
                                    </td>
                                </tr>
                            </table>
