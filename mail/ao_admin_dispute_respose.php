...
$aoName = $ao->username ?? 'AO';
$disputeId = $dispute->dispute_id ?? 'N/A';
$adminResponse = $dispute->admin_response ?? 'No response provided.';

$disputeLink = Yii::$app->urlManager->createAbsoluteUrl([
    'disputes/view',
    'id' => $disputeId,
]);
?>
                    ...
                    <tr>
                        <td style="padding:36px 38px;">
                            ...
                            <p style="margin:0 0 22px; font-size:15px; line-height:1.7; color:#374151;">
                                We are writing to inform you that a response has been provided regarding your dispute.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#1e40af;">
                                            An administrator has reviewed the dispute and submitted a response for your review.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding:0;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="width:35%; padding:13px 18px; border-top:1px solid #e5e7eb; font-size:13px; font-weight:700; color:#6b7280;">
                                                    Dispute ID
                                                </td>
                                                <td style="padding:13px 18px; border-top:1px solid #e5e7eb; font-size:14px; color:#111827;">
                                                    #<?= Html::encode($disputeId) ?>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:13px 18px; border-top:1px solid #e5e7eb; font-size:14px; color:#111827; line-height:1.6;">
                                                    <?= nl2br(Html::encode($adminResponse)) ?>
                                                </td>
                                            </tr>
                            ...
                            <div style="text-align:center; margin:30px 0;">
                                <a href="<?= Html::encode($disputeLink) ?>"
                            ...
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.7; color:#374151;">
                                Please log in to your account to review the dispute details and current status.
                            </p>
