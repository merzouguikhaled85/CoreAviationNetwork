...
$originalDate = !empty($appointment->appointment_date)
    ? Yii::$app->formatter->asDatetime($appointment->appointment_date)
    : 'N/A';

$rescheduledDate = !empty($appointment->reschedule_appointment_date)
    ? Yii::$app->formatter->asDatetime($appointment->reschedule_appointment_date)
    : 'N/A';
?>
                    ...
                    <tr>
                        <td style="padding:36px 38px;">
                            ...
                            <p style="margin:0 0 22px; font-size:15px; line-height:1.7; color:#374151;">
                                We would like to inform you that the appointment has been rescheduled as per the following details.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#1e40af;">
                                            Please review the updated appointment details at your earliest convenience.
                                        </p>
                                    </td>
                                </tr>
                            </table>
