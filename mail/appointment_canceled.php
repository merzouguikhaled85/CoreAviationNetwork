                    ...
                    <tr>
                        <td style="padding:36px 38px;">
                            ...
                            <p style="margin:0 0 22px; font-size:15px; line-height:1.7; color:#374151;">
                                We would like to inform you that your scheduled appointment has been canceled.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#b91c1c;">
                                            This appointment is no longer active. Please contact the maintenance provider if you require additional information.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:0 0 14px; font-size:15px; line-height:1.7; color:#374151;">
                                If needed, you may request a new appointment through the platform.
                            </p>
