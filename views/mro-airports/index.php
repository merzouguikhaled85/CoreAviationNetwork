...
// Bootstrap Icons: same icon family used by the request pages.
...
$this->registerCss(<<<CSS
    ...
    /* Pagination: exact same visual design as mro-appointments */
...
if (typeof yii !== 'undefined') {
    yii.confirm = function (message, okCallback, cancelCallback) {
        ...
        Swal.fire({
            ...
            cancelButtonText: '<i class="bi bi-box-arrow-left"></i> Keep airport',
...
<main class="dash-content requests-page">
    <div class="container-fluid">
        ...
        <!-- Page header: same structure as request pages -->
            ...
            <div class="header-title-group">
                ...
                <div>
                    ...
                    <div class="subtitle-text">
                        Manage airports linked to your MRO. Search by airport name, city, country or ICAO.
                    </div>
                </div>
            </div>

            <?= Html::a(
                '<i class="bi bi-plus-circle"></i> Add Airport to MRO',
                ['create'],
                ['class' => 'btn btn-outline-success btn-add-request']
            ) ?>
        </div>

        <!-- Search card: same structure as request pages -->
            ...
            <?= Html::beginForm($filterUrl, 'get', [
                ...
                <div class="search-input-wrap">
                    ...
                    <?= Html::textInput('search', $searchQuery, [
                        ...
                        'placeholder' => 'Search by airport name, city, country or ICAO...',
                ...
                <?= Html::a(
                    ...
                    [
                        'class' => 'btn btn-reset',
                        'title' => 'Reset search and show all airports',
                    ]
                ) ?>
            <?= Html::endForm() ?>
        ...
        <!-- Content card: same table structure as request pages -->
        <div class="content-card">
                        ...
                        <?php if (!empty($airports)): ?>
                            <?php foreach ($airports as $airport): ?>
                                <?php
                                    ...
                                    $airportId = $airport->airport_id ?? null;
                                    $airportName = $airport->airport_name ?? 'N/A';
                                    $cityName = $airport->city->city_name ?? 'N/A';
                                    $countryName = $airport->country->country_name ?? 'N/A';
                                    $icao = $airport->icao ?? null;
                                ?>
                                <tr>
                                    <td data-label="Airport Name">
                                        <span class="airport-name-text">
                                        ...
                                        <div class="action-buttons">
                                            <?= Html::a(
                                                ...
                                                [
                                                    ...
                                                    'data' => [
                                                        'confirm' => 'Airport ID #' . $airportId . ' - ' . $airportName . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
                                ...
                                <td colspan="5">
                                    <div class="empty-state">
                                        ...
                                        <div class="empty-state-title">
                                            <?php if ($searchQuery !== ''): ?>
                                                No airports found for your current search.
                                            <?php else: ?>
                                                No airports linked to your MRO for now.
                                            <?php endif; ?>
                                        </div>
                                        <div class="empty-state-text">
                                            <?php if ($searchQuery !== ''): ?>
                                                Try another airport name, city, country or ICAO code.
                                            <?php else: ?>
                                                Add an airport to make it available in your MRO network.
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
            ...
            <!-- Pagination: same structure as mro-appointments -->
