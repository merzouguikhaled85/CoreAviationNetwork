...
/** @var app\models\MroAircraftCertificates $model */

/**
 * This view supports both variable names:
 * - $certificate from the old working controller
 * - $model if another controller sends model
 */
...
/**
 * Keep the old working data source.
 */
$certificateId = $certificateModel->aircraft_certificate_id ?? $certificateModel->id ?? 'N/A';

$mroName = $certificateModel->mro->username ?? 'N/A';

$manufacturer = $certificateModel->aircraftModel->manufacturer ?? 'N/A';

$aircraftModelName = $certificateModel->aircraftModel->model ?? 'N/A';

$certificateFile = $certificateModel->certificate ?? null;
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Review aircraft certificate information and download the official document.
                </div>
            </div>
