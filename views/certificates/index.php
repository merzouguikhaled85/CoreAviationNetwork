...
// Keep compatibility if controller sends $search or if search comes from GET.
$searchQuery = isset($search)
    ? trim((string) $search)
    : trim((string) Yii::$app->request->get('search', ''));
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Manage certificates, NAA types, files, and related MRO users
                </div>
            </div>
            ...
            <?= Html::beginForm(['index'], 'get', [
                ...
                <div class="search-input-wrap">
                    ...
                    <?= Html::textInput('search', $searchQuery, [
                        ...
                        'placeholder' => 'Search by type or certificate...',
                        'autocomplete' => 'off',
                    ]) ?>
                </div>
                                ...
                                <tr>
                                    <td data-label="ID">
                                        <?= Html::a(
                                            ...
                                            ['view', 'id' => $certificate->certificate_id],
                                            ['class' => 'request-link']
                                        ) ?>
                                    </td>

                                    <td data-label="NAA">
                                        <?php if (!empty($certificate->type)): ?>
                                    ...
                                    <td data-label="Certificate">
                                        <?php if (!empty($certificate->certificate)): ?>
                                            <?= Html::a(
                                    ...
                                    <td data-label="MRO">
                                        <?php if ($certificate->mro): ?>
                                            <span class="mro-badge">
                                                <i class="bi bi-person-check"></i>
                                                <?= Html::encode($certificate->mro->username) ?>
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['update', 'id' => $certificate->certificate_id],
                                                [
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['delete', 'id' => $certificate->certificate_id],
                                                [
                                                    'class' => 'action-btn btn-delete',
                                                    'title' => 'Delete',
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Certificate #' . $certificate->certificate_id . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
