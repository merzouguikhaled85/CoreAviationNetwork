...
/**
 * Prepare country data safely.
 */
$countryName = $country->country_name ?? 'N/A';
$countryCode = $country->country_code ?? 'N/A';

/**
 * Page title.
 */
$this->title = 'View Country: ' . $countryName;
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Detailed information about this country record.
                </div>
            </div>
            ...
            <div class="content-card">
                ...
                <div class="detail-list">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php if (!empty($countryCode) && $countryCode !== 'N/A'): ?>
                                <span class="code-badge">
                                    <i class="bi bi-hash"></i>
                                    <?= Html::encode($countryCode) ?>
                                </span>
                            <?php else: ?>
                                <span class="empty-badge">
                                    <i class="bi bi-dash-circle"></i>
