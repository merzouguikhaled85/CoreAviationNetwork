...
// Keep "search" because your controller already uses this parameter.
...
if (typeof yii !== 'undefined') {
    yii.confirm = function (message, okCallback, cancelCallback) {
        ...
        Swal.fire({
            ...
            cancelButtonText: '<i class="bi bi-box-arrow-left"></i> Keep country',
...
<main class="dash-content requests-page">
    <div class="container-fluid">
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Manage and track your countries
                </div>
            </div>

            <?= Html::a(
                '<i class="bi bi-plus-circle"></i> Add a country',
                ['country/create'],
        ...
        <div class="search-filter-card">
            ...
            <?= Html::beginForm(['country/index'], 'get', [
                        ...
                        <?php if (!empty($countries)): ?>
                            <?php foreach ($countries as $country): ?>
                                <tr>
                                    <td data-label="ID">
                                        <?= Html::a(
                                            '#' . Html::encode($country->country_id),
                                            ['view', 'id' => $country->country_id],
                                            ['class' => 'request-link']
                                        ) ?>
                                    </td>
                                    ...
                                    <td data-label="Country Name">
                                        ...
                                        <?= Html::encode($country->country_name) ?>
                                    </td>

                                    <td data-label="Country Code">
                                        <span class="country-code-badge">
                                            <i class="bi bi-flag"></i>
                                            <?= Html::encode($country->country_code) ?>
                                        </span>
                                    </td>
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['delete', 'id' => $country->country_id],
                                                [
                                                    'class' => 'action-btn btn-delete',
                                                    'title' => 'Delete',
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Country #' . $country->country_id . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
