...
/** @var app\models\MroInsuranceDocuments $model */

/**
 * Page title and breadcrumbs.
 */
$this->title = 'Insurance Document #' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Insurance Documents', 'url' => ['index']];
...
/**
 * Prepare document data safely.
 */
$fileName = $model->file_name ?: 'N/A';
$fileType = $model->file_type ?: 'N/A';
$fileSize = !empty($model->file_size)
    ? round($model->file_size / 1024, 2) . ' KB'
    : 'N/A';

$uploadedAt = !empty($model->created_at)
    ? $model->created_at
    : 'N/A';

$documentUrl = $buildFileUrl($model->file_path ?? null);
...
<main class="dash-content requests-page">
    <div class="container-fluid">
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Detailed information about the uploaded insurance document.
                </div>
            </div>
        ...
        <div class="view-grid">
            ...
            <!-- Main insurance document details -->
                ...
                <div class="detail-list">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php if (!empty($documentUrl)): ?>
                                <?= Html::a(
                                    '<i class="bi bi-eye"></i> Download / View',
                                    $documentUrl,
                                    [
                                        'target' => '_blank',
                                        'rel' => 'noopener',
                    ...
                    <!-- <div class="detail-item full-width">
                        ...
                        <div class="document-preview-box">
                            <?= Html::encode($model->file_path ?: 'N/A') ?>
                        </div>
                    </div> -->
            ...
            <div class="content-card">
                ...
                <div class="quick-actions">
                    ...
                    <?php if (!empty($documentUrl)): ?>
                        <?= Html::a(
                            '<i class="bi bi-eye"></i> Download / View Document',
                            $documentUrl,
                            [
                                'target' => '_blank',
                                'rel' => 'noopener',
                    ...
                    <?= Html::a(
                        '<i class="bi bi-arrow-left-circle"></i> Back to Insurance Documents',
                        $backUrl,
