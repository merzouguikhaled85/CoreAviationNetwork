...
/**
 * Prepare city data safely.
 */
$cityName = $city->city_name ?? 'N/A';
$countryName = $city->country->country_name ?? 'N/A';

/**
 * Page title.
 */
$this->title = 'View City: ' . $cityName;
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Detailed information about this city and its linked country.
                </div>
            </div>
