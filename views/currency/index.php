...
if (typeof yii !== 'undefined') {
    yii.confirm = function (message, okCallback, cancelCallback) {
        ...
        Swal.fire({
            ...
            cancelButtonText: '<i class=\"bi bi-box-arrow-left\"></i> Keep currency',
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Manage currency names, codes, symbols, and creation dates
                </div>
            </div>

            <?= Html::a(
                '<i class="bi bi-plus-circle"></i> Add a Currency',
                ['create'],
                                ...
                                <tr>
                                    ...
                                    <td data-label="Code">
                                        <span class="currency-code-badge">
                                            <i class="bi bi-upc"></i>
                                            <?= Html::encode($currency->code) ?>
                                        </span>
                                    </td>

                                    <td data-label="Symbol">
                                        <?php if (!empty($currency->symbol)): ?>
                                            <span class="currency-symbol-badge">
                                                <i class="bi bi-currency-dollar"></i>
                                                <?= Html::encode($currency->symbol) ?>
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td data-label="Created At">
                                        <span class="date-badge">
                                            ...
                                            <?= Html::encode(Yii::$app->formatter->asDatetime($currency->created_at)) ?>
                                        </span>
                                    </td>
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <?= Html::a(
                                                ...
                                                [
                                                    ...
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Currency ' . $currency->code . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
