 ...
 */
$username = $aoProfile->username ?? 'N/A';
$email = $aoProfile->email ?? 'N/A';
$companyName = $aoProfile->company_name ?? 'N/A';
$contactNumber = $aoProfile->contact_number ?? 'N/A';

/**
 * Prepare current profile photo safely.
 */
$currentPhoto = $aoProfile->profile_photo ?? null;
$currentPhotoName = !empty($currentPhoto)
    ? basename((string) $currentPhoto)
    : 'No current photo';
...
$currentPhotoUrl = !empty($currentPhoto)
    ? $buildFileUrl($currentPhoto)
    : null;
...
/**
 * Same route and same city logic as the original AO profile page.
 */
$cityUrl = Url::to(['ao-profile/cities-by-country']);
...
/**
 * Register page CSS.
 * The classes below follow the same design used by the Update Certificate page.
 */
...
function openProfilePhotoPopup(photoSrc, title) {
    if (!photoSrc) {
        return;
    }
...
function updateFilePreview() {
    ...
    if (fileInput.files && fileInput.files.length > 0) {
        ...
        fileNameLabel.textContent = 'No new photo selected';
        fileNameLabel.title = '';
    }
}
...
function getProfileField(attributeName) {
    return $('#ao-profile-form').find('[name$="[' + attributeName + ']"]').first();
}
...
function checkProfileFormReady(showState = true) {
    ...
    const isReady = usernameOk && emailOk && countryOk && cityOk && addressOk && zipCodeOk;
...
$(document).ready(function() {
    ...
    $(document).on('click', '.js-profile-photo-popup', function() {
        openProfilePhotoPopup($(this).attr('src'), $(this).data('photo-title') || 'Profile photo');
    });
    ...
    form.on('beforeSubmit', function(e) {
        ...
        if (!checkProfileFormReady(true)) {
            Swal.fire({
                ...
                html: 'Please complete all required fields before updating the AO profile.',
                icon: 'warning',
        ...
        Swal.fire({
            title: 'Confirm AO profile update?',
            html: 'Please confirm that the AO profile information is correct before saving changes.',
            icon: 'warning',
            showCancelButton: true,
            // FORM DIALOG ACTIONS: replace generic choices with explicit profile actions.
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Update the Aircraft Operator profile information while keeping the same clean certificate update design.
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field-card">
                        ...
                        <?= $form->field($aoProfile, 'username')->textInput([
                            'class' => 'form-control',
                    ...
                    <div class="form-field-card">
                        ...
                        <?= $form->field($aoProfile, 'email')->textInput([
                            'class' => 'form-control',
                    ...
                    <div class="form-field-card">
                        ...
                        <?= $form->field($aoProfile, 'first_name')->textInput([
                            'class' => 'form-control',
                    ...
                    <div class="form-field-card">
                        ...
                        <?= $form->field($aoProfile, 'last_name')->textInput([
                            'class' => 'form-control',
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field-card">
                        ...
                        <?= $form->field($aoProfile, 'contact_number')->textInput([
                            'class' => 'form-control',
                    ...
                    <div class="form-field-card">
                        ...
                        <?= $form->field($aoProfile, 'company_name')->textInput([
                            'class' => 'form-control',
                    ...
                    <div class="form-field-card full-width">
                        ...
                        <div class="custom-file-box">
                            ...
                            <div class="custom-file-info">
                                <span id="selected-file-name" class="custom-file-name">
                        ...
                        <div id="profile-photo-preview-wrapper" class="photo-preview-wrapper">
                            <div class="current-file-box">
                                ...
                                <div class="current-file-text">
                                    <span class="current-file-label">New photo preview</span>
                                ...
                                <img
                                    ...
                                    class="current-photo-thumb js-profile-photo-popup"
                        ...
                        <?php if (!empty($currentPhoto)): ?>
                            <div class="current-file-box">
                                ...
                                <div class="current-file-text">
                                    ...
                                    <span class="current-file-name" title="<?= Html::encode($currentPhotoName) ?>">
                                        <?= Html::encode($currentPhotoName) ?>
                                    </span>
                                ...
                                <?php if (!empty($currentPhotoUrl)): ?>
                                    <img
                                        src="<?= Html::encode($currentPhotoUrl) ?>"
                                        alt="Current profile photo"
                                        class="current-photo-thumb is-clickable js-profile-photo-popup"
                                        data-photo-title="Current profile photo"
                                        title="Click to preview"
                                    >
                                <?php endif; ?>

                                <?= Html::hiddenInput('profile_photo_existing', $currentPhoto) ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field-card full-width">
                        ...
                        <?= $form->field($aoProfile, 'address')->textInput([
                            'maxlength' => true,
                            'class' => 'form-control',
                    ...
                    <div class="form-field-card">
                        ...
                        <?= $form->field($aoProfile, 'zip_code')->textInput([
                            'maxlength' => true,
                            'class' => 'form-control',
                ...
                <div class="form-actions">
                    ...
                    <?= Html::submitButton(
                        '<i class="bi bi-check-circle"></i> Update AO Profile',
                        [
            ...
            <div class="helper-card">
                ...
                <div class="helper-list">
                    ...
                    <div class="helper-item">
                        ...
                        <p class="helper-text">
                            If no new photo is selected, the existing profile photo is kept using the hidden existing photo input.
                        </p>
                    </div>
                    ...
                    <div class="helper-item">
                        ...
                        <p class="helper-text">
                            A confirmation popup appears before saving, using the same SweetAlert style as the certificate update page.
                        </p>
                    </div>
                </div>
            </div>
