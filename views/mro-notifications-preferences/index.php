...
$this->title = 'MRO Notification Preferences';
...
<main class="dash-content">
    <div class="container-fluid">
        <h1 class="dash-title">MRO Notification Preferences</h1>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-lg-12">
                <?= Html::beginForm(['mro-notifications-preferences/index'], 'get', ['class' => 'form-inline']) ?>
        ...
        <div class="row">
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Notify by Email1</th>
                        <th>Notify by Platform</th>
                        <th>Certified Aircraft</th>
                        <th>Non Certified Aircraft</th>
                        <th>Appointment Acceptance</th>
                        <th>Feedback</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($preferences as $preference): ?>
                        <tr>
                            ...
                            <td><?= Html::encode($preference->notify_for_certified_aircraft ? 'true' : 'false') ?></td>
                            <td><?= Html::encode($preference->notify_for_non_certified_aircraft ? 'true' : 'false') ?></td>
                            <td><?= Html::encode($preference->notify_for_appointment_acceptance ? 'true' : 'false') ?></td>
                            <td><?= Html::encode($preference->notify_for_feedback ? 'true' : 'false') ?></td>
                            <td>
