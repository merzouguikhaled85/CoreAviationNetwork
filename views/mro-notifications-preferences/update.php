...
$this->params['breadcrumbs'][] = ['label' => 'Account', 'url' => ['/mro/profile/update']];
...
<div class="notification-pref-wrapper can-form-page">
    <div class="notification-pref-card" role="region" aria-label="Notification Preferences">
        ...
        <div class="notification-body">
            ...
            <div class="mb-3">
                ...
                <div class="notification-switch">
                    <div class="notification-switch-main">
                        ...
                        <div>
                            <div class="notification-switch-label">Non-certified aircraft</div>
                            <div class="notification-switch-desc">
                                Get an alert when an aircraft without valid certification is involved.
                            </div>
                        </div>
                    </div>
                    <div>
                        <?= $form->field($model, 'notify_for_non_certified_aircraft', [
                            'options' => ['class' => 'form-check form-switch mb-0'],
                            'template' => '{input}{error}',
                        ])->checkbox(['class' => 'form-check-input', 'label' => false]) ?>
                    </div>
                ...
                <div class="notification-switch">
                    <div class="notification-switch-main">
                        ...
                        <div>
                            <div class="notification-switch-label">Appointment acceptance</div>
                            <div class="notification-switch-desc">
                                Be notified when an appointment request is accepted or updated.
                            </div>
                        </div>
                    </div>
                    <div>
                        <?= $form->field($model, 'notify_for_appointment_acceptance', [
                            'options' => ['class' => 'form-check form-switch mb-0'],
                            'template' => '{input}{error}',
                        ])->checkbox(['class' => 'form-check-input', 'label' => false]) ?>
                    </div>
                ...
                <div class="notification-switch">
                    <div class="notification-switch-main">
                        ...
                        <div>
                            <div class="notification-switch-label">Feedback & surveys</div>
                            <div class="notification-switch-desc">
                                Receive notifications when new feedback or ratings are available.
                            </div>
                        </div>
                    </div>
                    <div>
                        <?= $form->field($model, 'notify_for_feedback', [
                            'options' => ['class' => 'form-check form-switch mb-0'],
                            'template' => '{input}{error}',
                        ])->checkbox(['class' => 'form-check-input', 'label' => false]) ?>
                    </div>
            ...
            <!-- mro_id caché -->
            <?= $form->field($model, 'mro_id')
                ->hiddenInput(['value' => Yii::$app->user->identity->mro_id])
                ->label(false) ?>
