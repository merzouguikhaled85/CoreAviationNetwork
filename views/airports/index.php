...
<main class="dash-content requests-page">
    <div class="container-fluid">
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Manage airports, cities, countries, and ICAO codes
                </div>
            </div>
        ...
        <div class="search-filter-card">
            <?= Html::beginForm(['airports/index'], 'get', [
                ...
                <div class="search-input-wrap">
                    ...
                    <?= Html::textInput('search', $searchQuery, [
                        ...
                        'placeholder' => 'Search by airport name or ICAO...',
                        'autocomplete' => 'off',
                    ]) ?>
                </div>
                        ...
                        <?php if (!empty($airports)): ?>
                            <?php foreach ($airports as $airport): ?>
                                <tr>
                                    <td data-label="ID">
                                        <?= Html::a(
                                            '#' . Html::encode($airport->airport_id),
                                            ['view', 'id' => $airport->airport_id],
                                            ['class' => 'request-link']
                                        ) ?>
                                    </td>

                                    <td data-label="Airport Name">
                                        <span class="airport-badge">
                                            <i class="bi bi-airplane-engines"></i>
                                            <?= Html::encode($airport->airport_name) ?>
                                        </span>
                                    </td>

                                    <td data-label="City">
                                        <?php if (!empty($airport->city)): ?>
                                            <span class="city-badge">
                                                <i class="bi bi-buildings"></i>
                                                <?= Html::encode($airport->city->city_name) ?>
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td data-label="Country">
                                        <?php if (!empty($airport->country)): ?>
                                            <span class="country-badge">
                                                <i class="bi bi-globe2"></i>
                                                <?= Html::encode($airport->country->country_name) ?>
                                            </span>
                                        <?php else: ?>
                                            <span class="empty-badge">
                                                <i class="bi bi-exclamation-circle"></i>
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['delete', 'id' => $airport->airport_id],
                                                [
                                                    'class' => 'action-btn btn-delete',
                                                    'title' => 'Delete',
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Airport #' . $airport->airport_id . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
