...
/** @var array<int,string>|null $mroMap */
/** @var array<int,appmodelsRequests>|null $requestMap */
...
// REQUEST DETAILS MODAL 2026: keep the view safe when rendered without the optional map.
...
/* Custom page design: same CSS/HTML structure used by mro-appointments */
...
if (typeof yii !== 'undefined') {
    yii.confirm = function (message, okCallback, cancelCallback) {
        ...
        var isConfirmAction = lowerMessage.indexOf('confirm') !== -1 || lowerMessage.indexOf('confirmed') !== -1;
        var isCancelAction = lowerMessage.indexOf('cancel') !== -1 || lowerMessage.indexOf('cancelled') !== -1 || lowerMessage.indexOf('canceled') !== -1 || lowerMessage.indexOf('remove') !== -1 || lowerMessage.indexOf('delete') !== -1;

        var alertTitle = isConfirmAction ? 'Confirm this appointment?' : 'Cancel this appointment?';
        var alertIcon = isConfirmAction ? 'question' : 'warning';
        var confirmText = isConfirmAction
            ? '<i class="bi bi-check-circle-fill"></i> Confirm'
            : '<i class="bi bi-x-circle-fill"></i> Cancel Appointment';
        var confirmButtonClass = 'swal-delete-confirm' + (isConfirmAction ? ' confirm-style' : '');
...
// REQUEST DETAILS MODAL 2026: plain text dates for modal values.
...
<main class="dash-content requests-page can-list-page">
    <div class="container-fluid">
            ...
            <?= Html::beginForm($filterUrl, 'get', [
                ...
                <div class="search-input-wrap">
                    ...
                    <?= Html::textInput('search', $searchQuery, [
                        ...
                        'placeholder' => 'Search by request ID, MRO, status or date...',
                        'autocomplete' => 'off',
                    ]) ?>
                </div>
        ...
        <?php
        /*
         * SYNCHRONISATION DE LA LISTE AO : les attributs data decrivent le contexte
         * autorise et URL du fragment. Le script global remplace seulement ce bloc,
         * donc la recherche, la page courante et la modale restent intactes.
         * Le curseur serveur assure la reprise sans perdre un événement intermédiaire.
         */
        ?>
        <div id="ao-appointments-list"
             data-request-sync-context="ao-appointments"
