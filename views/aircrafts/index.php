        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Manage and track aircraft models, registration numbers, and owners
                </div>
            </div>

            <?= Html::a(
                '<i class="bi bi-plus-circle"></i> Add Aircraft Model',
                ['create'],
                        ...
                        <?php if (!empty($aircraftModels)): ?>
                            <?php foreach ($aircraftModels as $aircraftModel): ?>
                                <tr>
                                    <td data-label="ID">
                                        <?= Html::a(
                                            '#' . Html::encode($aircraftModel->aircraft_id),
                                            ['view', 'id' => $aircraftModel->aircraft_id],
                                            ['class' => 'request-link']
                                        ) ?>
                                    </td>
                                    ...
                                    <td data-label="Manufacturer">
                                        ...
                                        <?= Html::encode($aircraftModel->manufacturer) ?>
                                    </td>

                                    <td data-label="Model">
                                        <span class="aircraft-badge">
                                            <i class="bi bi-airplane-engines"></i>
                                            <?= Html::encode($aircraftModel->model) ?>
                                        </span>
                                    </td>
                                    ...
                                    <td data-label="Serial Number">
                                        <span class="serial-badge">
                                            ...
                                            <?= Html::encode($aircraftModel->serial_number) ?>
                                        </span>
                                    </td>
                                    ...
                                    <td data-label="Registration Number">
                                        <span class="serial-badge">
                                            ...
                                            <?= Html::encode($aircraftModel->registration_number) ?>
                                        </span>
                                    </td>

                                    <td data-label="Owner Username">
                                        <?php if ($aircraftModel->owner): ?>
                                            <span class="owner-badge">
                                                <i class="bi bi-person-check"></i>
                                                <?= Html::encode($aircraftModel->owner->username) ?>
                                            </span>
                                        <?php else: ?>
                                            <span class="owner-empty">
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['update', 'id' => $aircraftModel->aircraft_id],
                                                [
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['delete', 'id' => $aircraftModel->aircraft_id],
                                                [
                                                    'class' => 'action-btn btn-delete',
                                                    'title' => 'Delete',
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Aircraft #' . $aircraftModel->aircraft_id . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
