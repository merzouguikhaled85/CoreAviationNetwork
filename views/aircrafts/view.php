...
/** @var app\models\AircraftModel $aircraftModel */
...
$model = $aircraftModel->model ?? 'N/A';
$serialNumber = $aircraftModel->serial_number ?? 'N/A';
$registrationNumber = $aircraftModel->registration_number ?? 'N/A';
$ownerUsername = $ownerUsername ?? 'N/A';
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Detailed information about this aircraft model.
                </div>
            </div>
                ...
                <div class="detail-list">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php if (!empty($manufacturer) && $manufacturer !== 'N/A'): ?>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php if (!empty($serialNumber) && $serialNumber !== 'N/A'): ?>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php if (!empty($registrationNumber) && $registrationNumber !== 'N/A'): ?>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php if (!empty($ownerUsername) && $ownerUsername !== 'N/A'): ?>
                                <span class="owner-badge">
                                    <i class="bi bi-person-check"></i>
                                    <?= Html::encode($ownerUsername) ?>
                                </span>
                            <?php else: ?>
                                <span class="empty-badge">
