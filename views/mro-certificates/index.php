...
/**
 * Helper function to display a specific icon according to the NAA type.
 */
if (!function_exists('getNaaIcon')) {
    function getNaaIcon($type)
    {
        $typeUpper = strtoupper((string) $type);

        if (strpos($typeUpper, 'EASA') !== false) {
            return '<i class="bi bi-shield-check"></i>';
        }

        if (strpos($typeUpper, 'FAA') !== false) {
            return '<i class="bi bi-airplane-engines"></i>';
        }

        if (strpos($typeUpper, 'DGAC') !== false) {
            return '<i class="bi bi-flag"></i>';
        }

        if (strpos($typeUpper, 'GCAA') !== false) {
            return '<i class="bi bi-building-check"></i>';
        }

        return '<i class="bi bi-folder-check"></i>';
    }
}
...
<!-- PHASE 6: shared list presentation; certificate rules remain unchanged. -->
<main class="dash-content requests-page can-list-page">
    <div class="container-fluid">

        <!-- Page header: same structure as MRO Airports -->
            ...
            <div class="header-title-group">
                ...
                <div>
                    ...
                    <div class="subtitle-text">
                        Manage your NAA approvals and quickly download each certificate.
                    </div>
                </div>
            </div>
        ...
        <!-- Search card: same structure as MRO Airports -->
            ...
            <?= Html::beginForm($filterUrl, 'get', [
                ...
                <div class="search-input-wrap">
                    ...
                    <?= Html::textInput('search', $searchQuery, [
                        ...
                        'placeholder' => 'Search by NAA type or certificate...',
                ...
                <?= Html::a(
                    ...
                    [
                        'class' => 'btn btn-reset',
                        'title' => 'Reset search and show all certificates',
                    ]
                ) ?>
            <?= Html::endForm() ?>
        ...
        <!-- Content card: same table structure as MRO Airports -->
        <div class="content-card">
            <div class="table-responsive-custom">
                <table class="table requests-table">
                    <thead>
                        <tr>
                            <th>NAA - National Aviation Authority</th>
                            <th>Certificate</th>
                        ...
                        <?php if (!empty($certificates)): ?>
                            <?php foreach ($certificates as $certificate): ?>
                                <?php
                                    ...
                                    $certificateType = $certificate->type ?? 'N/A';
                                    $certificateFile = $certificate->certificate ?? null;
                                    $fileUrl = !empty($certificateFile) ? Url::to($certificateFile, true) : null;
                                ?>
                                <tr>
                                    <td data-label="NAA">
                                        <span class="cert-badge">
                                            <?= getNaaIcon($certificateType) ?>
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            <?= Html::a(
                                                '<i class="bi bi-eye"></i>',
                                                ['view', 'id' => UrlIdHelper::encode($certificateId)],
                                                [
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['update', 'id' => UrlIdHelper::encode($certificateId)],
                                                [
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['delete', 'id' => UrlIdHelper::encode($certificateId)],
                                                [
                                                    ...
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Certificate ID #' . $certificateId . ' - ' . $certificateType . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
                                ...
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <div class="empty-state-title">
                                            <?php if ($searchQuery !== ''): ?>
                                                No certificates found for your current search.
                                            <?php else: ?>
                                                No certificates linked to your MRO for now.
                                            <?php endif; ?>
                                        </div>
                                        <div class="empty-state-text">
                                            <?php if ($searchQuery !== ''): ?>
                                                Try another NAA type or certificate name.
                                            <?php else: ?>
                                                Add a certificate to complete your MRO approvals profile.
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
