...
$(document).ready(function () {
    ...
    $('#certificate-type-create-form').on('beforeSubmit', function () {
        var form = $(this);
        ...
        Swal.fire({
            ...
            html: 'Are you sure you want to create this certificate type?',
            icon: 'question',
...
<main class="dash-content certificate-create-page can-form-page">
    <div class="container-fluid">
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Create a new National Aviation Authority certificate type.
                </div>
            </div>

            <?= Html::a(
                '<i class="bi bi-arrow-left"></i> Back to Certificate Types',
                ['index'],
        ...
        <div class="form-center-wrapper">
            ...
            <!-- Create certificate type form card -->
            <div class="content-card">
                ...
                <?php $form = ActiveForm::begin([
                    'id' => 'certificate-type-create-form',
                    'options' => [
                        'autocomplete' => 'off',
                    ],
                ]); ?>
                    ...
                    <div class="form-row-center">
                        <div class="form-column">
                            ...
                            <?= $form->field($model, 'type')->textInput([
                                'maxlength' => true,
                                'class' => 'form-control',
                                'placeholder' => 'Enter NAA certificate type',
                            ])->label(
                                'NAA<span class="required-star">*</span>',
                                ['encode' => false]
                            ) ?>
                    ...
                    <div class="form-actions">
                        <?= Html::submitButton(
                            '<i class="bi bi-check-circle"></i> Create Certificate Type',
