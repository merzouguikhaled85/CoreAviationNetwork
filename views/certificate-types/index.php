...
if (typeof yii !== 'undefined') {
    yii.confirm = function (message, okCallback, cancelCallback) {
        ...
        Swal.fire({
            ...
            cancelButtonText: '<i class="bi bi-box-arrow-left"></i> Keep type',
...
<main class="dash-content requests-page">
    <div class="container-fluid">
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Manage NAA certificate types
                </div>
            </div>

            <?= Html::a(
                '<i class="bi bi-plus-circle"></i> Add Certificate Type',
                ['create'],
        ...
        <div class="search-filter-card">
            <?= Html::beginForm(['certificate-types/index'], 'get', [
                        ...
                        <?php if (!empty($certificateTypes)): ?>
                            <?php foreach ($certificateTypes as $certificateType): ?>
                                <tr>
                                    <td data-label="ID">
                                        <?= Html::a(
                                            '#' . Html::encode($certificateType->certificate_type_id),
                                            ['view', 'id' => $certificateType->certificate_type_id],
                                            ['class' => 'request-link']
                                        ) ?>
                                    </td>

                                    <td data-label="NAA">
                                        <?php if (!empty($certificateType->type)): ?>
                                            <span class="type-badge">
                                                <i class="bi bi-patch-check"></i>
                                                <?= Html::encode($certificateType->type) ?>
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['update', 'id' => $certificateType->certificate_type_id],
                                                [
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['delete', 'id' => $certificateType->certificate_type_id],
                                                [
                                                    'class' => 'action-btn btn-delete',
                                                    'title' => 'Delete',
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Certificate type #' . $certificateType->certificate_type_id . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
                            ...
                            <tr class="empty-row">
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <div>No certificate types found.</div>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
