...
if (typeof yii !== 'undefined') {
    yii.confirm = function (message, okCallback, cancelCallback) {
        ...
        Swal.fire({
            width: 380,
            title: 'Delete this aircraft model?',
            html:
            ...
            cancelButtonText: '<i class="bi bi-box-arrow-left"></i> Keep model',
...
<main class="dash-content requests-page">
    <div class="container-fluid">
        ...
        <div class="page-header-card">
            <div>
                ...
                <div class="subtitle-text">
                    Manage aircraft manufacturers and models
                </div>
            </div>
        ...
        <div class="search-filter-card">
            <?= Html::beginForm(['aircraft-model/index'], 'get', [
                        ...
                        <?php if (!empty($aircraftModels)): ?>
                            <?php foreach ($aircraftModels as $aircraftModel): ?>
                                <tr>
                                    <td data-label="ID">
                                        <?= Html::a(
                                            '#' . Html::encode($aircraftModel->aircraft_model_id),
                                            ['view', 'id' => $aircraftModel->aircraft_model_id],
                                            ['class' => 'request-link']
                                        ) ?>
                                    </td>
                                    ...
                                    <td data-label="Actions">
                                        <div class="action-buttons">
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['update', 'id' => $aircraftModel->aircraft_model_id],
                                                [
                                            ...
                                            <?= Html::a(
                                                ...
                                                ['delete', 'id' => $aircraftModel->aircraft_model_id],
                                                [
                                                    'class' => 'action-btn btn-delete',
                                                    'title' => 'Delete',
                                                    'data-bs-toggle' => 'tooltip',
                                                    'data' => [
                                                        'confirm' => 'Aircraft model #' . $aircraftModel->aircraft_model_id . ' will be permanently deleted.',
                                                        'method' => 'post',
                                                    ],
                                                ]
                                            ) ?>
                            ...
                            <tr class="empty-row">
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <div>No aircraft models found.</div>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
